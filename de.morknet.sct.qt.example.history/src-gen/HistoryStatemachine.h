...
class HistoryStatemachine : public QObject, public sc::EventDrivenInterface
{
	Q_OBJECT
	
	public:
		explicit HistoryStatemachine(QObject *parent) noexcept;
		...
		static constexpr const sc::integer scvi_main_region_Start_main_StateA {0};
		static constexpr const sc::integer scvi_main_region_Start_main_StateA_Inner_Left_Red {0};
		static constexpr const sc::integer scvi_main_region_Start_main_StateA_Inner_Left_Blue {0};
		static constexpr const sc::integer scvi_main_region_Start_main_StateA_Inner_Left_Green {0};
		static constexpr const sc::integer scvi_main_region_Start_main_StateB {0};
		static constexpr const sc::integer scvi_main_region_Start_main_StateB_Inner_Right_Magenta {0};
		static constexpr const sc::integer scvi_main_region_Start_main_StateB_Inner_Right_Cyan {0};
		static constexpr const sc::integer scvi_main_region_Outside {0};
