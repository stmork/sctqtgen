...
/*!
 * Forward declaration for the AbstractDelay state machine.
 */
 class AbstractDelay;
...
typedef enum  {
	...
	Gui_button2,
	Gui_complete
} AbstractDelayEventName;

class SctEvent
{
	public:
		SctEvent(AbstractDelayEventName name) : name(name){}
		virtual ~SctEvent(){}
		const AbstractDelayEventName name;
...
{
	public:
		TypedSctEvent(AbstractDelayEventName name, T value) :
			SctEvent(name),
			value(value)
			{}
...
{
	public:
		SctEvent_Gui_button1(AbstractDelayEventName name) : SctEvent(name){};
};
class SctEvent_Gui_button2 : public SctEvent
{
	public:
		SctEvent_Gui_button2(AbstractDelayEventName name) : SctEvent(name){};
};
class SctEvent_Gui_complete : public SctEvent
{
	public:
		SctEvent_Gui_complete(AbstractDelayEventName name) : SctEvent(name){};
};
...
class AbstractDelay : public QObject, public sc::StatemachineInterface
{
	Q_OBJECT
	
	public:
		AbstractDelay(QObject *parent);
