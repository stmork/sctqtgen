...
AbstractStateMachine::Gui::Gui(AbstractStateMachine* parent) :
...
SctEvent* AbstractStateMachine::getNextEvent()
{
...
void AbstractStateMachine::dispatch_event(SctEvent * event)
{
	if(event == 0) {
		return;
	}
	switch(event->name)
	{
		case AbstractStateMachineEventName::Gui_pressed:
		{
			ifaceGui.dispatch_event(event);
			break;
		}
		case AbstractStateMachineEventName::Internal_trigger:
		{
			internal_dispatch_event(event);
			break;
		}
		case AbstractStateMachineEventName::Trigger_main_region_Lanes_r1_A_time_event_0:
		{
			timeEvents[0] = true;
			break;
		}
		case AbstractStateMachineEventName::Trigger_main_region_Lanes_r2_B_time_event_0:
		{
			timeEvents[1] = true;
			break;
		}
		case AbstractStateMachineEventName::Trigger_main_region_Lanes_r3_C_time_event_0:
		{
			timeEvents[2] = true;
			break;
		}
...
void AbstractStateMachine::Gui::dispatch_event(SctEvent * event)
{
	switch(event->name)
	{
		case AbstractStateMachineEventName::Gui_pressed:
...
void AbstractStateMachine::internal_dispatch_event(SctEvent * event)
{
	switch(event->name)
	{
		case AbstractStateMachineEventName::Internal_trigger:
...
AbstractStateMachineEventName AbstractStateMachine::getTimedEventName(sc_eventid evid)
{
...
sc_boolean AbstractStateMachine::check() {
...
void AbstractStateMachine::setTimerService(sc::timer::TimerServiceInterface* timerService)
{
	this->timerService = timerService;
}

sc::timer::TimerServiceInterface* AbstractStateMachine::getTimerService()
{
	return timerService;
}
...
AbstractStateMachine::Gui* AbstractStateMachine::gui()
{
	return &ifaceGui;
}
/* Functions for event pressed in interface Gui */
void AbstractStateMachine::gui_pressed()
{
	inEventQueue.push_back(new SctEvent_Gui_pressed(AbstractStateMachineEventName::Gui_pressed));
	runCycle();
}
void AbstractStateMachine::Gui::internal_gui_pressed()
{
	pressed_raised = true;
}
...
sc_integer AbstractStateMachine::Gui::getCounter() const
{
	return counter;
}

void AbstractStateMachine::Gui::setCounter(sc_integer value)
{
	this->counter = value;
}

/* Functions for event trigger in interface Internal */
void AbstractStateMachine::trigger()
{
	internalEventQueue.push_back(new SctEvent_Internal_trigger(AbstractStateMachineEventName::Internal_trigger));
	runCycle();
}
void AbstractStateMachine::internal_trigger()
{
	trigger_raised = true;
}
sc_boolean AbstractStateMachine::isRaisedTrigger() const
{
...
sc_integer AbstractStateMachine::react(const sc_integer transitioned_before) {
	/* State machine reactions. */
	return transitioned_before;
}

sc_integer AbstractStateMachine::main_region_Wait_react(const sc_integer transitioned_before) {
...
sc_integer AbstractStateMachine::main_region_Lanes_react(const sc_integer transitioned_before) {
...
sc_integer AbstractStateMachine::main_region_Lanes_r1_A_react(const sc_integer transitioned_before) {
...
sc_integer AbstractStateMachine::main_region_Lanes_r1__final__react(const sc_integer transitioned_before) {
...
sc_integer AbstractStateMachine::main_region_Lanes_r2_B_react(const sc_integer transitioned_before) {
...
sc_integer AbstractStateMachine::main_region_Lanes_r2__final__react(const sc_integer transitioned_before) {
	/* The reactions of state null. */
	sc_integer transitioned_after = transitioned_before;
	if ((transitioned_after) < (1))
	{ 
...
sc_integer AbstractStateMachine::main_region_Lanes_r3_C_react(const sc_integer transitioned_before) {
...
sc_integer AbstractStateMachine::main_region_Lanes_r3__final__react(const sc_integer transitioned_before) {
	/* The reactions of state null. */
	sc_integer transitioned_after = transitioned_before;
	if ((transitioned_after) < (2))
	{ 
...
sc_integer AbstractStateMachine::main_region_Lanes_guard_wait_react(const sc_integer transitioned_before) {
	/* The reactions of state wait. */
	sc_integer transitioned_after = transitioned_before;
...
void AbstractStateMachine::clearInternalEvents() {
	trigger_raised = false;
}

void AbstractStateMachine::microStep() {
